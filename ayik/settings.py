"""
Django settings for ayik project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-pe9(u@1!x#btr7#8v8u8w_ge*rqv*kju$y%(v_grsl3@e=nse5')
...
WSGI_APPLICATION = 'ayik.wsgi.application'
